      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.notifications_off_outlined, size: 48, color: FxColors.textMuted),
          ),
          const SizedBox(height: 24),
          Text('No notifications', style: FxText.titleLg()),
          const SizedBox(height: 8),
          Text("You're all caught up.", style: FxText.bodyMd()),
        ],
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(err, textAlign: TextAlign.center, style: FxText.bodyMd()),
            const SizedBox(height: 16),
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        item.title,
                        style: FxText.titleMd(),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                    ),
                    const SizedBox(width: 8),
                    Text(item.createdAt, style: FxText.bodySm(color: FxColors.textMuted)),
                  ],
                ),
